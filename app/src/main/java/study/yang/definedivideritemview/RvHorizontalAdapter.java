...
public   class RvHorizontalAdapter extends RecyclerView.Adapter<RvHorizontalAdapter.RvHolder> {
    ...
    public RvHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        ...
        RecyclerView.LayoutParams rlp = new RecyclerView.LayoutParams(100, RecyclerView.LayoutParams.MATCH_PARENT);
